...
module character::character {
    ...
    fun equip_armour(owner: &signer, character: Object<Character>, armour: Object<ArmourToken>) acquires Character {
        let character_obj = borrow_global_mut<Character>(object::object_address<Character>(&character));
    ...
    fun equip_trinket(owner: &signer, character: Object<Character>, trinket: Object<TrinketToken>) acquires Character {
